...
// Esta classe serve de ponte para comunicação entre
// a presistência e o framework Spring Security
public class UsuarioSecurity implements UserDetails {
    ...
    public boolean isCredentialsNonExpired() {
        // Flag que indica se as credenciais estão desbloqueada
        return true;
    }
    ...
    //dos nosso usuários salvos no banco de dados
}
