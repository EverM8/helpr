...
public class Chamado {
    ...
    private LocalDate dataAbertura = LocalDate.now(); //Não é necessário preencher a dataAbertura, pois será preenchido automaticamente

    private LocalDate dataFechamento;

    @Enumerated(EnumType.STRING) //REPRESENTA O ENUM "ESCRITO"
    private StatusChamado status = StatusChamado.RECEBIDO; //Recebido / Atribuído / Concluído
